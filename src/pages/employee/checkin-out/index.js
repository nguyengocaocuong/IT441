        ...
        <div className='check__in__out'>
            ...
            <div className='check__form__container'>
                ...
                <div className='check__form__column avatar__container'>
                    <img className='checkinout__avatar' alt='user' src={avatar} />
                </div>
            </div>
                                    ...
                                    <TableRow key={index}>
                                        {
                                            week.map(day => (
                                                <TableCell key={day.id} align='center'>
                                                    <div className='day'>
                                                        <span>{day.id}</span>
                                                        <div className={`work__item ${day.morning && 'worked'}`} >Sáng</div>
                                                        <div className={`work__item ${day.afternoon && 'worked'}`} >Chiều</div>
                                                    </div>
                                                </TableCell>
                                            ))
                                        }
